...
<body>
    ...
    <div class="container">
        <div class="recent-post-ctn" style="">
            <div class="recent-post-title btn notika-btn-gray btn-reco-mg btn-button-mg waves-effect pageHeader">
                <h2>Inquiries</h2><button id="sendMsgbtn" class="btn" data-toggle="modal" data-target="#myModalone" style="background-color: white;right:6%;">Send Message</button>
            </div>					
	    </div>
		<div class="row">
                    ...
                    <div class="modal-dialog modals-default">
                        <div class="modal-content">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                                <div class="nk-int-st">
                                                    <input id="iName" type="text" class="form-control" list="inquirierNameList" placeholder="Enter / Select Name"/>
                                                    <datalist id="inquirierNameList"></datalist>
                                                 </div>  
                                            </div>
                                        </div>
                            ...
                            <div class="modal-footer">
                                <button id="sendMsgBtn" type="button" class="btn btn-default">Send</button>
                            </div>                                
                    </div>
                </div>
			</div>
    ...
    <script src="PageJS/inquiries.js"></script>    
