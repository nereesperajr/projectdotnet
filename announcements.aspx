	...
	<div class="container">
        <div class="recent-post-ctn" style="">
            <div id="pageHeader" class="recent-post-title btn notika-btn-gray btn-reco-mg btn-button-mg waves-effect pageHeader">
                <h2 >Announcements</h2><button id="regNewbtn" class="btn" data-toggle="modal" data-target="#myModalone" style="background-color: white"><i class="notika-icon notika-plus-symbol"></i></button>
            </div>					
	    </div>
		<div class="row">
