...
<body class="google-map-single" >
    <div id="map2" style=" height : 100%; width : 100%; top : 0; left : 0; position : absolute; z-index : 200">

    </div>
   <div class="header-top-area" style="position: absolute;top:1.5%;left: 50px; right: 30px; z-index:999;  background:rgba(255,255,255,0.5);">
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="logo-area">
                        <%--<a href="#"><img src="img/logo/dmp_logo.jpg" alt="" /></a>--%>
                        <h2 style="color:rgb(0, 0, 0);"><span>Davao Memorial Park</span></h2>
                    </div>
                </div>
                        ...
                        <ul class="nav navbar-nav notika-top-nav">
                            <li class="nav-item dropdown">
                                <div  style="margin-top: 15px;">
                                     <button id="signInBtn" type="button" class="btn btn-default" style="color:rgb(0, 0, 0);">Sign In</button>          
                                </div>                            
                            </li>
                            <li class="nav-item dropdown" style="margin-left:8px;margin-bottom:10px;">
                                <div style="margin-top:15px;">
                                     <button id="inquireBtn" type="button" class="btn btn-default" data-toggle="modal" data-target="#myModalone" style="color:rgb(0, 0, 0);">Inquire</button>          
                                </div>                              
                            </li>                           
                        </ul>                       
                    </div>                  
     ...
     <div style="position: absolute;top:11%;right: 50px;z-index:9999; background:rgba(255,255,255,0.5);padding:10px;">        
            <span style="text-align:left;font-size: 15px;color:rgb(0, 0, 0);font-weight:bold;"><img src="images/tomb.png"/> - Occupied </span>            
            <br /><br />
            <span style="top:5px; text-align:left;font-size: 15px;color:rgb(0, 0, 0);font-weight:bold;"><img src="images/tomb_2.png"/> - Vacant  </span>                                        
    </div>
    ...
    <!-- Main Menu area End-->
    <!-- Start Status area -->
    <div style="position: absolute;top: 11%;left: 50px;z-index:9999; background:rgba(255,255,255,0.5);padding:10px;">    
        <%--<div class="nk-int-st">
        ...
        <div>  <%--style="margin-left:-5.5%;">--%>
	        ...
	        <div class="nk-int-st">
                ...
                <input id="searchDeceased" class="form-control" list="searchdeceasedList" style="display:-webkit-inline-box!important;">
            </div>            
        </div>    
        <br />
    ...
    <script>        
       ...
       //AIzaSyB0eg3LkOHTd7zH9qZYJfCDmD1yMZ_sAE4
	  //AIzaSyCVOIQ3qXUCmKVVV7DVexPzlgBcj5mQJmQ
    </script>
    <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDgLJ7jMQ1kcG3ptdOcfdDk_C3-SdMvs-g&callback=initMap">
    </script>
