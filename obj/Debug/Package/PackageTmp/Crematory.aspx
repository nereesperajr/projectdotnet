...
<body>
   ...
   <%-- <div class="recent-post-ctn" style="">
	...
	<div class="container">
        <div class="recent-post-ctn" style="">
            <div class="recent-post-title btn notika-btn-gray btn-reco-mg btn-button-mg pageHeader">
                <h2>Crematory</h2><button id="cremNewbtn" class="btn" data-toggle="modal" data-target="#myModalone" style="background-color: white"><i class="notika-icon notika-plus-symbol"></i></button>
            </div>					
	    </div>
        <div class="data-table-area">
             <div class="container">
    ...
    <script src="PageJS/crematory.js"></script>    
