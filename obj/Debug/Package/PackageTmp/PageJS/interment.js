var ClientJS = function () {
    ...
    function loadList(grid) {
        ...
        function loadListHTML(list) {
            ...
            $("#data-table-basic2").find('thead').html("<tr><th>Name</th><th>Date of Birth</th><th>Location</th><th>Date of Death</th><th>Date Added</th><th></th></tr >");
            ...
            $("#data-table-basic2").find('tbody').html(_html2);
